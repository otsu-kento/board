...
class Admin extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['message_array'] = $this->Board_model->fetch_all_rows();
    ...
    public function edit()
    {
        ...
        if (empty($data['message_data'] = $this->Board_model->fetch_one_row($id))) {
    ...
    public function download_csv()
    {
        ...
        $message_array = $this->Board_model->fetch_all_rows($limit);
    ...
    public function update()
    {
        ...
        if ($this->Board_model->update_row($id, $data)) {
    ...
    public function delete_bbs()
    {
        ...
        if ($this->Board_model->delete_row($id)) {
